document.addEventListener("DOMContentLoaded", function() {
  ...
  function priceButton(txjIn, dvdIn, tmp){
    ...
    let divTable = document.getElementById("priceTableData");
    divTable.innerHTML = "";
    ...
    let divpriceTable = document.getElementById("priceTable");
    ...
    divpriceTable.appendChild(table2);
  }
  ...
  document.getElementById("priceExample").addEventListener("click", function() {
    buttonChoice = false;
    priceButton();
  });
});
